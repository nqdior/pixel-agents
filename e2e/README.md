...
- `e2e/standalone/copilot-vscode.spec.ts:11` — VS Code Copilot office adopts and launches Copilot terminals without Claude hooks
- `e2e/standalone/copilot.spec.ts:13` — Copilot office adopts existing sessions across folders and tracks live lifecycle
